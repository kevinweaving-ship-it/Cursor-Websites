...
class ClubAdminScoreMinTest(unittest.TestCase):
    ...
    def test_appendix_a_discard_and_rank(self):
        ...
        self.assertEqual(h["_appendix_a_cell_points"]("(32DSQ)", 9), 10.0)
        self.assertEqual(h["_public_race_code_cell"]("DSQ", 9), "10 DSQ")
        self.assertEqual(h["_public_race_code_cell"]("DSQ", 14), "15 DSQ")
        self.assertEqual(h["_public_race_cell"]("DSQ", 9), "10 DSQ")
        self.assertEqual(h["_public_race_cell"]("DSQ", 14, True), "(15 DSQ)")
        self.assertEqual(h["_public_race_cell"]("32DSQ", 31, True), "(32 DSQ)")
        ...
        self.assertIn("function rowNett", self.club_js)
        self.assertIn("function rankLabel", self.club_js)
        ...
        self.assertIn("trg_update_sailor_counts", sql)
        self.assertIn("trg_queue_standings_recalc", sql)
    ...
    def test_places_unique_codes_repeat(self):
        ...
        self.assertEqual(h["_validate_race_score_value"]("10.0 DSQ", 9), "10 DSQ")
        ...
        self.assertIn('crew.classList.add("cape-crew--admin")', self.club_js)
        self.assertIn(".regatta-page--club-score-edit .cape-crew--hidden", self.src)
