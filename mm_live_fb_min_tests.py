...
class LiptonMmCardUnitTest(unittest.TestCase):
    def test_helper_is_hard_scoped(self):
        ...
        self.assertIn(".mm-lipton-reels-track{position:absolute;left:0;right:0;bottom:0;height:33.333%", src)
        ...
        self.assertIn("lipton-dev-trail-r7.json", js)
        self.assertIn("2622643364847262", js)
        self.assertIn("pickFrontPack", js)
