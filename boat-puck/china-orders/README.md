# China orders — collate from chats + Google Sheet

Working folder for **China sample / factory orders**. Paste chats here (or in this Cursor thread). Updates land in `ORDERS.md` + `sheet.csv` (copy into the Google Sheet).

**Paste next:** Dev WhatsApp, Lucas/OTW, Eric/Shenzhen, or any other supplier chat.
...
Google Sheet URL: *paste when ready — until then `sheet.csv` is the source.*
