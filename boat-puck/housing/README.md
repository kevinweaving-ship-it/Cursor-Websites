...
| `packing-mockup.md` | **Puck vs Screen insert** packing + fit PNGs |
| `gopro-h9-13-packing-mockup.scad` | 3D packing mockup (OpenSCAD) |
| `render_packing_mockup.py` | Regenerates packing PNGs |
