...
Runs only while the event is active (see mm_fb_event_window.py).
...
from mm_fb_event_window import event_is_active, skip_payload, sync_cape_fb_timers  # noqa: E402
