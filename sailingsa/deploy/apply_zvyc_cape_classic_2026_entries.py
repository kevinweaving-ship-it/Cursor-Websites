...
# Previous 2026 fleets (before this CSV): Extra, ILCA 4/6/7, Optimist A/B, Sonnet.
...
CLASS_MAP = {
    ...
    "ilca 7": ("ILCA 7", "Ilca 7", 46, "ilca-fleet"),
    "laser": ("Laser", "Ilca 7", 46, "ilca-fleet"),
    "ilca 6": ("ILCA 6", "Ilca 6", 45, "ilca-fleet"),
    "ilca": ("ILCA", "Ilca 6", 45, "ilca-fleet"),
    "ilca 4": ("ILCA 4", "Ilca 4.7", 8, "ilca-fleet"),
    "ilca 4.7": ("Ilca 4.7", "Ilca 4.7", 8, "ilca-fleet"),
    "laser 4.7": ("Laser 4.7", "Ilca 4.7", 8, "ilca-fleet"),
...
def map_class(raw_class: str) -> tuple[str, str, int, str]:
...
def ensure_block(cur, suffix: str) -> None:
    meta = BLOCKS[suffix]
    ...
    cur.execute(
        ...
        (
            ...
            REGATTA_ID,
            meta["class_original"],
            meta["class_canonical"],
            meta["fleet_label"] or None,
            RACES_SAILED,
            SCORING,
            meta["class_id"],
        ),
...
def main() -> int:
    ...
    with conn:
        with conn.cursor() as cur:
            ...
            for suffix in {p["suffix"] for p in planned}:
                ensure_block(cur, suffix)

            for p in planned:
                meta = BLOCKS[p["suffix"]]
