#!/usr/bin/env python3
"""Patch live api.py: public Lipton slug must NOT serve the -dev playback shell.

PR35 playback stays on ...-cup-dev only. Never overwrite live api.py with the repo copy.
"""
...
MARKER = "LIPTON_PUBLIC_NOT_DEV_V1"
...
def main() -> int:
    ...
    n = text.count(OLD)
    if n != 1:
        print(f"FAIL public-not-dev: found {n}", file=sys.stderr)
        return 1
