...
def setup_html(has_page_token: bool) -> str:
    ...
    return (
        ...
        "<p>App: <b>SailingSA MM Live</b>. Config: <b>MM Page LIVE</b>.</p>"
        f"<p><b>Page token on server:</b> {has}</p>"
        "<h2 class=\"section-title\">Paste a Page token</h2>"
        "<p>Only if Connect below fails. Token must be the Marine Megastore Page, not a person.</p>"
        ...
        "<p>Already saved on live. Do not change it unless Meta issues a new one.</p>"
