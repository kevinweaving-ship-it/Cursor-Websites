#!/usr/bin/env node
// Google OAuth Setup - Updated for Google Auth Platform
...
console.log('\n🔐 Google OAuth Setup - Google Auth Platform\n');
...
exec(`open "${brandingUrl}"`, () => {
  ...
  console.log('1. On the page that opened, click "Get started"');
  console.log('2. Configure your app:');
  console.log('   - App name: SailingSA Results');
  console.log('   - Support email: (your email)');
  console.log('   - App logo: (optional)');
  console.log('   - Click "Save"\n');
  
  console.log('3. Go to "Clients" in the left menu');
  ...
  console.log('9. Copy your credentials and paste below:\n');
