...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      ".ssa-regatta-slot-card .wx-wa-layer{display:none;position:absolute;inset:0;z-index:5;background:#ece5dd;overflow:auto;-webkit-overflow-scrolling:touch;padding:6px 8px 6px 24px;box-sizing:border-box;}",
