...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      ".ssa-regatta-slot-card .wx-wa-btn{position:absolute;top:2px;left:2px;z-index:6;width:44px;height:44px;padding:0;margin:0;border:0;background:transparent;cursor:pointer;display:flex;align-items:center;justify-content:center;-webkit-tap-highlight-color:transparent;}",
