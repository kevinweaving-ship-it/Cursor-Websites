...
(function () {
  ...
  function injectCss() {
    ...
    s.id = CSS_ID;
    s.textContent = [
      ".ssa-regatta-slot-card{display:block;width:100%;order:2;margin:10px 0 0;padding:8px;box-sizing:border-box;min-height:72px;background:#fff;border:1.5px solid #1a2750;border-radius:8px;box-shadow:0 1px 3px rgba(0,31,63,.08);}",
      "@media screen and (orientation:portrait) and (max-width:767px){",
      ".ssa-regatta-slot-card{margin:8px 0 0;min-height:64px;}",
      "}"
    ].join("");
