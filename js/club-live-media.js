/**
 * Permanent ZVYC club-page live media: Cape Classic weather card + MM reels
 * (ZVYC live cam first, then reels). Inserts below the club header / identity
 * panel and above About. No-op on other club slugs.
 */
(function () {
  'use strict';
  ...
  function placeHost() {
    ...
    if (existing) return fillHost(existing);
